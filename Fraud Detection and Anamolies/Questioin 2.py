...
# Split the data into Training (70%) and Testing (30%) partitions
...
means_and_stddev = data[['DEBTINC', 'LOAN', 'MORTDUE', 'VALUE']].agg(['mean', 'std'])
...
train_variable_statistics = train_data[selected_variables].agg(['mean', 'std'])
test_variable_statistics = test_data[selected_variables].agg(['mean', 'std'])
...
print(train_variable_statistics)
...
print("Frequency distribution of BAD (including missing):\n", test_bad_frequency)
print("\nMeans and standard deviations of selected variables:")
print(test_variable_statistics)
